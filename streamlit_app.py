...
# --- Sidebar ---
with st.sidebar:
    st.markdown("## 🛒 ABC Grocery AI")
    st.markdown(
        "- Answers based on the **internal ABC help guide** only.\n"
        "- Uses **RAG + conversational memory**.\n"
        "- Does not answer questions outside the provided document."
    )
...
# --- Header ---
st.markdown('<div class="abc-title"> Welcome to ABC Grocery AI Assistant</div>', unsafe_allow_html=True)
st.markdown(
    '<div class="abc-subtitle">Ask anything about ABC Grocery.</div>',
    unsafe_allow_html=True,
)
